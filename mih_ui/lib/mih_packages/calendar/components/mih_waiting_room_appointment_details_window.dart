...
import 'mih_appointment_update_window.dart';

class MihWaitingRoomAppointmentDetailsWindow extends StatefulWidget {
  ...
  final int index;
  const MihWaitingRoomAppointmentDetailsWindow({
    super.key,
  ...
  @override
  State<MihWaitingRoomAppointmentDetailsWindow> createState() =>
      _MihWaitingRoomAppointmentDetailsWindowState();
}

class _MihWaitingRoomAppointmentDetailsWindowState
    extends State<MihWaitingRoomAppointmentDetailsWindow> {
