...
class PatientViewPersonal extends StatefulWidget {
  //final AppUser signedInUser;
  final PatientViewArguments arguments;
  const PatientViewPersonal({
    super.key,
    required this.arguments,
  });

  @override
  State<PatientViewPersonal> createState() => _PatientViewState();
}

class _PatientViewState extends State<PatientViewPersonal> {
